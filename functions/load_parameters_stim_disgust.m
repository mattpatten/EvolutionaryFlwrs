...
st.t.sizeY                  = [0.20; 0.35];     %[0-Inf) the height (radius) of the ellipse for trans florets
...
st.r.sizeY                  = [0.20; 0.35];      %[0-Inf) the height (radius) of the ellipse for ray florets
