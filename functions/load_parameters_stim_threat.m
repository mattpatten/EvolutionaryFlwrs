...
st.t.sizeX                  = [0.40; 0.45; 0.50];      %[0-Inf) the length (radius) of the ellipse for trans florets
st.t.sizeY                  = [0.25; 0.35];     %[0-Inf) the height (radius) of the ellipse for trans florets
...
st.r.sizeX                  = [0.77; 0.87; 0.97];        %[0-Inf) the length (radius) of the ellipse for ray florets
st.r.sizeY                  = [0.25; 0.35];      %[0-Inf) the height (radius) of the ellipse for ray florets
...
st.r.tips_sharpness         = [0.80; 2.5; 3.0];  %(0-Inf) the sharpness of the tips/edges of the ray florets, of the order x.^n (i.e., 1 is linear/45 deg point, 2 is parabolic, 100 is absolutely flat)
...
st.t.orientation_shift_var  = [0; 30; 180];          %[0-180] the amount of variance (in degrees, ori_shift ± var) in placing the position/orientation of the next trans floret
...
st.t.avgPetals              = [5; 10; 15];         %[1-inf) number of trans florets to generate
st.t.avgPetals_var          = 3;          %[0-inf) the amount of variance (nPetals ± var) in the number of trans florets that might be displayed.
st.r.avgPetals              = [5; 20; 35]; %[1-inf) number of ray florets to generate 
...
st.h.avgHoles               = [-5; 10; 20];   %[1-inf)  number of holes to put inside disk florets, distributed proportionally across the rows (closer to the centre has less compared to close to the outside)
...
st.d.fractal_type           = [0];
st.t.fractal_type           = [0];
st.r.fractal_type           = [0; 2];     %(where X is flower region 'h','d','t',or'r')fractal_type summarises the top two variables. 0 means no fractal is shown, 1 means the regular fractal is displayed, and 2 means the thresholded/binary/ugly fractal is presented. It only takes 3 values. 
...
st.t.colour                 = [0.78431 0.22745 0.18431; 0.8902 0.54902 0.63922; 0.35686 0.69412 0.39216; 0.6902 0.64314 0.14118; 0.97255 0.83137 0.24314; 0.37647 0.27843 0.21176];
st.r.colour                 = [0.78431 0.22745 0.18431; 0.8902 0.54902 0.63922; 0.35686 0.69412 0.39216; 0.6902 0.64314 0.14118; 0.97255 0.83137 0.24314; 0.37647 0.27843 0.21176]; 
