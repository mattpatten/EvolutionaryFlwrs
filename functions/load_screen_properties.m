...
scr.viewingDistance = 0.57; %in metres

% Input details of the display monitor
scr.monitorSize_x = 0.346; %in metres
scr.monitorSize_y = 0.195; %in metres

% Define current screen to be used [0 - all, 1 - main, 2 - secondary]
scr.screenNum = 1; %max(Screen('Screens')); %sets as likely most convenient option
