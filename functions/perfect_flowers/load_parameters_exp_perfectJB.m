...
e.questionText = {'Which stimuli is the prettiest?','Which stimuli is the ugliest?'}; %[string] the question that you want the participant to respond to, written in the top left corner of the screen.
