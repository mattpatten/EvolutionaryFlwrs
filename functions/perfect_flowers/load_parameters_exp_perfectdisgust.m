...
e.questionText = {'Select most disgusting','Select least disgusting'}; %[string] the question that you want the participant to respond to, written in the top left corner of the screen.
