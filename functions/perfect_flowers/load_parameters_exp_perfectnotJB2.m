function [e] = load_parameters_exp_MP
...
%If there are 4 parameter values (25% to each parameter), 0.1 would shift 2.5% of the pie on each trial.
e.propPieChange = 0.15; 

%% instructions
e.displayText = 1; %[0,1] Whether you want to display text to the participant on each trial
e.questionText = {'Which stimuli is the easiest to look at?','Which stimuli is the hardest to look at?'}; %[string] the question that you want the participant to respond to, written in the top left corner of the screen.
...
e.backgroundColour = [0 0 0]; %0x3=black, 0.5x3=grey, 1x3=white
