function [e] = load_parameters_exp_RL
...
e.questionText = {'Select most threatening','Select least threatening'}; %[string] the question that you want the participant to respond to, written in the top left corner of the screen.
                                                                                                           %please select the most threatening image? Please select the least threatening image?'
%% screen layout
