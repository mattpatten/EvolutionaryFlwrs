...
st.d.size                   = [0.6; 0.6];         %diameter of central disk
...
st.t.sizeY                  = [0.28; 0.28; 0.28];   %[0-Inf) the height (radius) of the ellipse for trans florets
st.t.varX                   = [0; 0; 0.07; .07];   %[0-Inf) random variance (%) added in individual trans lengths
...
st.r.varX                   = [.15; .15; .15; .15];   %[0-Inf) random variance (%) added in individual petal lengths
...
st.t.tips_sharpness         = [0.8; 0.8; 0.8]; %(0-Inf) the sharpness of the tips/edges of the ray florets, of the order x.^n (i.e., 1 is linear/45 deg point, 2 is parabolic, 100 is absolutely flat)
...
st.t.fractal_type           = [1; 1; 1];
st.r.fractal_type           = [1; 1; 1];  %(where X is flower region 'h','d','t',or'r')fractal_type summarises the top two variables. 0 means no fractal is shown, 1 means the regular fractal is displayed, and 2 means the thresholded/binary/ugly fractal is presented. It only takes 3 values. 
...
st.t.colour                 = [0.8902 0.54902 0.63922; 0.8902 0.54902 0.63922; 0.8902 0.54902 0.63922; 0.8902 0.54902 0.63922];
