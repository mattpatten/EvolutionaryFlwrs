...
st.t.sizeY                  = [0.24; 0.24; 0.24];   %[0-Inf) the height (radius) of the ellipse for trans florets
...
st.r.varX                   = [.07; .07; .07; .07];   %[0-Inf) random variance (%) added in individual petal lengths
...
st.t.colour                 = [0.8902 0.54902 0.63922; 0.97255 0.83137 0.24314; 0.8902 0.54902 0.63922; 0.97255 0.83137 0.24314];
