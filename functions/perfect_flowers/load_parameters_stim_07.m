...
st.d.size                   = [0.60; 0.60];         %radius of central disk
...
st.t.sizeY                  = [0.20; 0.2; 0.2];   %[0-Inf) the height (radius) of the ellipse for trans florets
st.t.varX                   = [0.07; 0.07; 0.07; 0.07];   %[0-Inf) random variance (%) added in individual trans lengths
...
st.r.sizeY                  = [0.27; 0.27; 0.27];   %[0-Inf) the height (radius) of the ellipse for ray florets
...
st.r.tips_sharpness         = [0.8; 0.8; 0.8];    %(0-Inf) the sharpness of the tips/edges of the ray florets, of the order x.^n (i.e., 1 is linear/45 deg point, 2 is parabolic, 100 is absolutely flat)
...
st.t.avgPetals              = [33; 33; 33; 33];  %[6; 18; 33];      %[1-inf) number of trans florets to generate
st.t.avgPetals_var          = 3;                %[0-inf) the amount of variance (nPetals ± var) in the number of trans florets that might be displayed.
st.r.avgPetals              = [44; 44; 44; 44];  %[1-inf) number of ray florets to generate 
...
st.r.colour                 = [0.78431 0.22745 0.18431; 0.78431 0.22745 0.18431; 0.78431 0.22745 0.18431; 0.78431 0.22745 0.18431]; 
