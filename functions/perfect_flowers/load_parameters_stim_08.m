...
st.t.fractal_type           = [2; 2; 2];
st.r.fractal_type           = [2; 2; 2];  %(where X is flower region 'h','d','t',or'r')fractal_type summarises the top two variables. 0 means no fractal is shown, 1 means the regular fractal is displayed, and 2 means the thresholded/binary/ugly fractal is presented. It only takes 3 values. 
