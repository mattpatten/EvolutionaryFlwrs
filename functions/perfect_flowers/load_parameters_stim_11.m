...
st.t.sizeY                  = [0.20; 0.20; 0.20];   %[0-Inf) the height (radius) of the ellipse for trans florets
...
st.t.avgPetals              = [23; 23; 23; 23];  %[6; 18; 33];      %[1-inf) number of trans florets to generate
