...
st.t.varX                   = [0; 0; 0; 0]; %[0-Inf) random variance (%) added in individual trans lengths
st.t.varY                   = [0; 0; 0; 0];       %[0-Inf) random variance (%) added in individual trans widths
...
st.r.varY                   = [0.15; 0.15; .15; .15];       %[0-Inf) random variance (%) added in individual trans widths
