...
st.t.varX                   = [0.3; 0.3; .3; .3]; %[0-Inf) random variance (%) added in individual trans lengths
st.t.varY                   = [0.07; 0.07; .07; .07];       %[0-Inf) random variance (%) added in individual trans widths
...
st.t.orientation_shift_var  = [90; 90; 90];           %[0-180] the amount of variance (in degrees, ori_shift ± var) in placing the position/orientation of the next trans floret
...
st.t.avgPetals              = [33; 33; 33];         %[1-inf) number of trans florets to generate
...
st.d.fractal_type           = [1; 1];
st.t.fractal_type           = [1; 1];
st.r.fractal_type           = [1; 1];
