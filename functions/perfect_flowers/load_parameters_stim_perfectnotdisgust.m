...
st.t.sizeX                  = [0.50; 0.5; 0.50];      %[0-Inf) the length (radius) of the ellipse for trans florets
st.t.sizeY                  = [0.20; 0.2];     %[0-Inf) the height (radius) of the ellipse for trans florets
...
st.r.sizeX                  = [0.77; 0.77; 0.77];        %[0-Inf) the length (radius) of the ellipse for ray florets
st.r.sizeY                  = [0.20; 0.2];      %[0-Inf) the height (radius) of the ellipse for ray florets
...
st.t.tips_sharpness         = [3; 3; 3]; %(0-Inf) the sharpness of the tips/edges of the ray florets, of the order x.^n (i.e., 1 is linear/45 deg point, 2 is parabolic, 100 is absolutely flat)
...
st.r.tips_sharpness         = [0.80; 0.8; 0.8];  %(0-Inf) the sharpness of the tips/edges of the ray florets, of the order x.^n (i.e., 1 is linear/45 deg point, 2 is parabolic, 100 is absolutely flat)
...
st.r.orientation_shift_var  = [30; 30; 30]; %[0-180] the amount of variance (in degrees, ori_shift ± var) in placing the position/orientation of the next ray floret
...
st.t.avgPetals              = [10; 10; 10];         %[1-inf) number of trans florets to generate
st.t.avgPetals_var          = 3;          %[0-inf) the amount of variance (nPetals ± var) in the number of trans florets that might be displayed.
st.r.avgPetals              = [20; 20; 20]; %[1-inf) number of ray florets to generate 
...
st.d.fractal_type           = [0];
st.t.fractal_type           = [0];
st.r.fractal_type           = [0; 0];     %(where X is flower region 'h','d','t',or'r')fractal_type summarises the top two variables. 0 means no fractal is shown, 1 means the regular fractal is displayed, and 2 means the thresholded/binary/ugly fractal is presented. It only takes 3 values. 
...
st.t.colour                 = [0.97255 0.83137 0.24314; 0.97255 0.83137 0.24314; 0.97255 0.83137 0.24314; 0.97255 0.83137 0.24314; 0.97255 0.83137 0.24314; 0.97255 0.83137 0.24314];
st.r.colour                 = [0.8902 0.54902 0.63922; 0.8902 0.54902 0.63922; 0.8902 0.54902 0.63922; 0.8902 0.54902 0.63922; 0.8902 0.54902 0.63922; 0.8902 0.54902 0.63922]; 
