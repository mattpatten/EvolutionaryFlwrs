...
st.t.sizeY                  = [0.25; 0.25];     %[0-Inf) the height (radius) of the ellipse for trans florets
...
st.r.sizeY                  = [0.25; 0.25];      %[0-Inf) the height (radius) of the ellipse for ray florets
...
st.r.tips_sharpness         = [2.5; 2.5; 2.5];  %(0-Inf) the sharpness of the tips/edges of the ray florets, of the order x.^n (i.e., 1 is linear/45 deg point, 2 is parabolic, 100 is absolutely flat)
...
st.r.avgPetals              = [5; 5; 5]; %[1-inf) number of ray florets to generate 
